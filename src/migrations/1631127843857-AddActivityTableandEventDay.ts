...
export class AddActivityTableandEventDay1631127843857 implements MigrationInterface {
    name = "AddActivityTableandEventDay1631127843857"
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.query("CREATE TABLE \"eventDays\" (\"id\" SERIAL NOT NULL, \"date\" TIMESTAMP NOT NULL, CONSTRAINT \"PK_410702c0d792566db2e3e451fd4\" PRIMARY KEY (\"id\"))");
      await queryRunner.query("CREATE TABLE \"activities\" (\"id\" SERIAL NOT NULL, \"name\" character varying NOT NULL, \"startTime\" TIMESTAMP NOT NULL, \"endTime\" TIMESTAMP NOT NULL, \"vacancies\" integer NOT NULL, \"eventDayId\" integer, \"locationId\" integer, CONSTRAINT \"PK_7f4004429f731ffb9c88eb486a8\" PRIMARY KEY (\"id\"))");
